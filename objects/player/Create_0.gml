...
HOR_RUNSPEED=8
HOR_SHUFFLESPEED=10   ///shuffling is the small movement when you tap a key but release before holding
...
ground_dash_speed=10.5    ///speed of the current dash (if grounded).             WARNING             gets changed when attack happens so this value here means nothing
...
DASH_ROCKET_JUMP_AMOUNT_LEVELS=[0,8,14,18] ////vspd minued this amount depending on charge level
