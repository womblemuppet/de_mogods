...
if room==multiplayermenu
{
    ...
    /// if not competitive, draw coloured player backgrounds (temp)
        ...
        if ready[i]==0     /// selecting character
        {
            draw_text(menu_player_options_x[i]+50,menu_player_options_y[i]+50,lore_character_select_name[selectchar[i]])
    ...
    if startinggame>0
    {
        ...
        if startinggame>60
            t="3"
        else if startinggame>45
            t="2"
        else if startinggame>30
            t="1"
        else
            t="start"
