...
if room==init
{
    ...
    a.player_priority=irandom(playersin-1)+1
    with a
    {
        ...
        for (i=0; i<12; i+=1)
        {
            if kouchou.controllerin[i]!=-1
            {
                tempcontrollerid[kouchou.controllerin[i]]=i
                //show_message("setting tempcontrollerid "+string(kouchou.controllerin[i])+" to "+string(i))
            }
        };
    }
    
    for (i=0; i<playersin; i+=1)
    {
